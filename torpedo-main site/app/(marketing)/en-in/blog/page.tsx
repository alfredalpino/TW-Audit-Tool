...
import { BlogListWithSearch } from '@/app/(marketing)/blog/BlogListWithSearch';
import { BackToHomeLinkSm } from '@/components/BackToHomeLink';
import { FeaturedPostCard } from '@/app/(marketing)/blog/FeaturedPostCard';
import { BlogHeroHeadline } from '@/components/blog/BlogHeroHeadline';

const FEATURED_POST_SLUG = 'local-seo-audit-lucknow-checklist-that-finds-revenue-gaps';
...
export default async function EnInBlogPage() {
  const locale = await getRequestLocale();
