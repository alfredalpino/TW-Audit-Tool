...
## 22. Cursor prompt snippet (attach to tasks)

Copy into any Cursor instruction when building UI:

```text
Apply docs/DESIGN-GUIDE.md v2.1 exactly. Marketing page for torpedoweb.org.
Use ClientLayout shell, var(--*) colors only, Button + ClayCard components,
tw-section bands with border-t, clay skeuomorphism, font-display headlines,
useTextScramble eyebrows (900, 3000), Framer sectionVariants. No gray Tailwind.
Match homepage section rhythm: void/base/surface alternation.
```
